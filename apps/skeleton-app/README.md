...
| 図鑑名       | 概要                                                                           |
| ------------ | ------------------------------------------------------------------------------ |
| ポケモン図鑑 | ID・世代・タイプで検索し、ステータス・わざ・進化・フォームなどの詳細情報を確認 |
| わざ図鑑     | タイプ別にわざの一覧を表示し、各わざの詳細情報を確認                           |
| アイテム図鑑 | ポケット別（どうぐ・薬・ボール・わざマシンなど）にアイテムの一覧を表示         |
| 地方図鑑     | 11地方のロケーション一覧と、各エリアのエンカウントポケモンを確認               |
...
| ピッタリ 100kg    | バネ秤を使って目標の重さになるようにする           |
...
| サファリゲーム           | ボールを投げてポケモンに当てるビリヤードゲーム       |
| ポケモンピンボール       | モンスターボールでポケモンバンパーをはじくピンボール |

### べんきょう

| ゲーム名           | 概要                                     |
| ------------------ | ---------------------------------------- |
| ポケモン漢字ドリル | 図鑑テキストの漢字の読み・書きを確認する |
| バトル計算ドリル   | ポケモンのステータス値で四則演算する     |
| タイピングゲーム   | ポケモンの名前をローマ字でタイピングする |
