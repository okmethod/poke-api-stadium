...
| ゲーム名                 | 概要                                               |
| ------------------------ | -------------------------------------------------- |
| ポケモンだ〜れだ？       | シルエットからポケモンを当てる                     |
| ポケモンだ〜れだ？ 改    | LLM チャットに質問してポケモンを当てる             |
| たかさくらべ 改          | 3体のたかさを物理演算で比較                        |
| おもさくらべ 改          | 2体のおもさを物理演算で比較                        |
| ポケモン XX くらべ       | 各種ステータスでポケモンを並べ替え                 |
| なきごえならべ           | 3体のなき声を聞いて再生順に並べ替え                |
| あとだしタイプじゃんけん | 御三家の進化段階に応じて勝つ・負ける・あいこを選ぶ |

### パズル

| ゲーム名          | 概要                                               |
| ----------------- | -------------------------------------------------- |
| ポケモンしりとり  | ポケモンの名前でしりとり                           |
| ポケモンえあわせ  | 同じポケモンを物理演算で衝突判定して消す           |
| ポケモンめくり    | カードの神経衰弱                                   |
| ポケモンめくり 改 | 同じタイプのポケモンカードを探して揃える           |
| スライドパズル    | アートワークを15ピースに分けてスライドで完成させる |
| タイピングゲーム  | ポケモンの名前をローマ字でタイピング               |
| ばつぐんラッシュ  | モグラ叩きの要領で効果ばつぐんな技を選んで叩く     |
