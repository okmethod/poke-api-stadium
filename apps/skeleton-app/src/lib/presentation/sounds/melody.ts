...
export const sampleMelody: { melodyNotes: (MelodyNote | null)[]; defaultTempoBpm: number } = {
  melodyNotes: [
    // セクションA - フレーズ1: ドソドソーファーミレシー
    { name: "ド", octave: 4, duration: 1 },
    { name: "ソ", octave: 3, duration: 1 },
    { name: "ド", octave: 4, duration: 1 },
    { name: "ソ", octave: 4, duration: 2 },
    null,
    { name: "ファ", octave: 4, duration: 2 },
    null,
    { name: "ミ", octave: 4, duration: 1 },
    { name: "レ", octave: 4, duration: 1 },
    { name: "シ", octave: 3, duration: 3 },
    null,
    null,
    null,
    // セクションA - フレーズ2: シソシミーレーシドミー
    { name: "シ", octave: 3, duration: 1 },
    { name: "ソ", octave: 3, duration: 1 },
    { name: "シ", octave: 3, duration: 1 },
    { name: "ミ", octave: 4, duration: 2 },
    null,
    { name: "レ", octave: 4, duration: 2 },
    null,
    { name: "シ", octave: 3, duration: 1 },
    { name: "ド", octave: 4, duration: 1 },
    { name: "ミ", octave: 4, duration: 2 },
