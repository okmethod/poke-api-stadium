...
export const appSoundEffects: readonly SoundEffect[] = Object.entries(SE_ASSIGNMENTS).map(([name, { sound, desc }]) =>
 ...
 */
export const playSE = Object.fromEntries(appSoundEffects.map((se) => [se.name, se.play])) as {
