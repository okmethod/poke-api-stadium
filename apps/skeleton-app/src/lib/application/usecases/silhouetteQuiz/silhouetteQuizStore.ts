/**
 * silhouetteQuizStore - シルエットクイズのゲーム状態ストア
 *
 * @architecture レイヤー間依存ルール - アプリ層 (Store)
 * - ROLE: ゲーム状態の保持・更新（SilhouetteQuizFacade のみが書き込む）
...
/** SilhouetteQuizFacade からのみ使用するストア書き込みAPI */
export const silhouetteQuizStoreWriter = {
